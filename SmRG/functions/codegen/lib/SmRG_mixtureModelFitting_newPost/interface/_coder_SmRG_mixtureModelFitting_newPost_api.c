 ...
 *
 * _coder_SmRG_mixtureModelFitting_newPost_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "SmRG_mixtureModelFitting_newPost",  /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void SmRG_mixtureModelFitting_newPost_atexit(void)
{
  ...
  SmRG_mixtureModelFitting_newPost_xil_terminate();
  SmRG_mixtureModelFitting_newPost_xil_shutdown();
  ...
  const mxArray *plhs[6])
{
  ...
  SmRG_mixtureModelFitting_newPost(Vin, &K0_double, &vB_double, &mu_sk, &rk, tol,
    p_tot, a1);
...
/* End of code generation (_coder_SmRG_mixtureModelFitting_newPost_api.c) */
