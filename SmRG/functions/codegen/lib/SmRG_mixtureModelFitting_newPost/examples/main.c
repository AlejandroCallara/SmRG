...
#include "main.h"
#include "SmRG_mixtureModelFitting_newPost_terminate.h"
...
static void main_SmRG_mixtureModelFitting_newPost(void);
...
static void main_SmRG_mixtureModelFitting_newPost(void)
{
  ...
  /* Initialize function 'SmRG_mixtureModelFitting_newPost' input arguments. */
  /* Initialize function input argument 'Vin'. */
  Vin = c_argInit_UnboundedxUnbounded_r();

  /* Call the entry-point 'SmRG_mixtureModelFitting_newPost'. */
  K0_double_tmp = argInit_real_T();
  vB_double = K0_double_tmp;
  mu_sk = argInit_real_T();
  rk = argInit_real_T();
  SmRG_mixtureModelFitting_newPost(Vin, &K0_double_tmp, &vB_double, &mu_sk, &rk,
    p_tot, a1);
...
int main(int argc, const char * const argv[])
{
  ...
  main_SmRG_mixtureModelFitting_newPost();
