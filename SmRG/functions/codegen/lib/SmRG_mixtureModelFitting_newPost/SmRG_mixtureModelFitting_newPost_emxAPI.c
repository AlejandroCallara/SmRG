 ...
 *
 * SmRG_mixtureModelFitting_newPost_emxAPI.c
 *
 * Code generation for function 'SmRG_mixtureModelFitting_newPost_emxAPI'
 *
 */
...
/* End of code generation (SmRG_mixtureModelFitting_newPost_emxAPI.c) */
