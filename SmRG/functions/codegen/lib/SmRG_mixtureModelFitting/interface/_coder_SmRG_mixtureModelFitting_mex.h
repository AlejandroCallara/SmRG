 ...
 *
 * _coder_SmRG_mixtureModelFitting_mex.h
 *
 * Code generation for function '_coder_SmRG_mixtureModelFitting_mex'
 *
 */

#ifndef _CODER_SMRG_MIXTUREMODELFITTING_MEX_H
#define _CODER_SMRG_MIXTUREMODELFITTING_MEX_H
...
/* End of code generation (_coder_SmRG_mixtureModelFitting_mex.h) */
