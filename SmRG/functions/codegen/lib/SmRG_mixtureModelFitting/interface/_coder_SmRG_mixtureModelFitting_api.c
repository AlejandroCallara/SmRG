 ...
 *
 * _coder_SmRG_mixtureModelFitting_api.c
 *
 * Code generation for function '_coder_SmRG_mixtureModelFitting_api'
 *
 */
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "SmRG_mixtureModelFitting",          /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void SmRG_mixtureModelFitting_api(const mxArray * const prhs[5], int32_T nlhs,
  const mxArray *plhs[6])
{
  ...
  SmRG_mixtureModelFitting(Vin, &K0_double, &vB_double, &mu_sk, &rk, p_tot, a1);
...
void SmRG_mixtureModelFitting_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  SmRG_mixtureModelFitting_xil_terminate();
  SmRG_mixtureModelFitting_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void SmRG_mixtureModelFitting_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void SmRG_mixtureModelFitting_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_SmRG_mixtureModelFitting_api.c) */
