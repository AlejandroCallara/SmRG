 ...
 *
 * SmRG_mixtureModelFitting_newPost_tol.c
 *
...
#include "SmRG_mixtureModelFitting_newPost_tol_data.h"
#include "SmRG_mixtureModelFitting_newPost_tol_emxutil.h"
#include "SmRG_mixtureModelFitting_newPost_tol_initialize.h"
...
void SmRG_mixtureModelFitting_newPost_tol(const emxArray_real_T *Vin, double
  ...
  emxArray_real_T *p_tot, emxArray_real_T *a1)
{
  ...
  int nx;
  boolean_T exitg1;
  if (!isInitialized_SmRG_mixtureModelFitting_newPost_tol) {
...
/* End of code generation (SmRG_mixtureModelFitting_newPost_tol.c) */
